...
class IntMsg(BaseMsg):
    ...
    def __init__(self, listener_or_name, name, value):
        """
        Initialize a new integer message.
    ...
    def send_actual(self, listener):
        ...
        """
        listener.receive_int(self)
    
    def get_value(self):
        """
        Get the integer value contained in this message.
